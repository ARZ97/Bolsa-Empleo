...
<head>
  ...
  <title>CIBTF | Editar Usuario</title>
                  ...
                  <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <c:if test="${not empty status}">
                          <c:if test="${status == 'done'}">
                            <div class="alert alert-success fade in">
                              ...
                              <strong>Hecho!</strong> El usuario fue actualizado correctamente
                            </div>
                          </c:if>
                          <c:if test="${status == 'error'}">
                            <div class="alert alert-block alert-danger fade in">
                              ...
                              <strong>Ups!</strong> No se pudo actualizar a este usuario
                            </div>
                          </c:if>
                          <c:if test="${status == 'newPass'}">
                            <div class="alert alert-success fade in">
                              <button data-dismiss="alert" class="close close-sm" type="button">
                                                  <i class="icon-remove"></i>
                                              </button>
                              <strong>Hecho!</strong> La contraseña del usuario ha sido restablecida, se le enviará un correo con la información
                            </div>
                          </c:if>
                        </c:if>
                      ...
                      <div class="panel-body">
                        <div class="form">
                          <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="EditarUsuarioServlet">
                            ...
                            <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                <input class="form-control" id="nombreUsuario" name="nombreUsuario" minlength="5" type="text" value="${usuario.getNombreUsuario()}" required />
                              </div>
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                <input class="form-control" id="apellidosUsuario" name="apellidosUsuario" minlength="5" type="text" value="${usuario.getApellidosUsuario()}" required />
                              </div>
                            </div>
                            ...
                            <div class="form-group ">
                              ...
                              <div class="col-lg-10">
                                <input class="form-control " id="correoUsuario" type="email" name="correoUsuario" value="${usuario.getCorreoUsuario()}" required />
                              </div>
                            </div>
                            ...
                            <input type="hidden" id="statusUsuario" name="statusUsuario" value="${usuario.getStatusUsuario()}" >

                            <div class="form-group">
                              <label for="idUniversidad" class="control-label col-lg-2">Universidad</label>
                              <div class="col-lg-10">
                                <select class="form-control m-bot15" id="idUniversidad" name="idUniversidad">
                                  <c:if test="${usuario.getIdUniversidad() == 0}">
                                  ...
                                  <c:forEach items="${universidades}" var="universidad">
                                    <c:if test="${universidad.getIdRegistro() == usuario.getIdUniversidad()}">
                                      <option value="${universidad.getIdRegistro()}" selected>${universidad.getNombreRegistro()}</option>
                                    </c:if>
                                    <c:if test="${universidad.getIdRegistro() != usuario.getIdUniversidad()}">
                                      <option value="${universidad.getIdRegistro()}">${universidad.getNombreRegistro()}</option>
                                    </c:if>
                                  </c:forEach>
                              </select>
                              </div>
                            ...
                            <div class="form-group">
                              <label for="idEmpresa" class="control-label col-lg-2">Empresa</label>
                              <div class="col-lg-10">
                                <select class="form-control m-bot15" id="idEmpresa" name="idEmpresa">
                                  <c:if test="${usuario.getIdEmpresa() == 0}">
                                    <option value="0" selected>Ninguna</option>
                                  </c:if>
                                  <c:if test="${usuario.getIdEmpresa() != 0}">
                                    <option value="0">Ninguna</option>
                                  ...
                                  <c:forEach items="${empresas}" var="empresa">
                                    <c:if test="${empresa.getIdRegistro() == usuario.getIdEmpresa()}">
                                      <option value="${empresa.getIdRegistro()}" selected>${empresa.getNombreRegistro()}</option>
                                    </c:if>
                                    <c:if test="${empresa.getIdRegistro() != usuario.getIdEmpresa()}">
                                      <option value="${empresa.getIdRegistro()}">${empresa.getNombreRegistro()}</option>
                                    </c:if>
                                  </c:forEach>
                              </select>
                              </div>
                            ...
                            <div class="form-group">
                              <div class="col-lg-offset-2 col-lg-10">
                                ...
                                <a class="btn btn-danger" href="EliminarUsuarioServlet?idUsuario=${usuario.getIdUsuario()}&correoUsuario=${usuario.getCorreoUsuario()}">Eliminar</a>&nbsp;&nbsp;&nbsp;
                                <a class="btn btn-warning" href="RestablecerPasswordServlet?idUsuario=${usuario.getIdUsuario()}&correoUsuario=${usuario.getCorreoUsuario()}">Restablecer Contraseña</a>
                              </div>
                            </div>
                          </form>
                        </div>
