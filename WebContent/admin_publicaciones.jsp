          ...
          <div class="table-responsive" style="overflow-x:auto;" >
            <table class="table table-striped table-advance table-hover" >
              <thead>
                  ...
                  <th><i class="icon_tools"></i>Eliminar</th>
              </thead>
              <tbody>
                <c:forEach items="${listaEventos}" var="evento">
                  <tr>
                    ...
                    <td>
                      ...
                      <c:if test="${evento.getStatusEvento() == 4}">Sin Revisar</c:if>
                    </td>
                    <c:if test="${sessionUser.getRolUsuario() == 'admin'}">
                      <td>
                        <div class="btn-group">
                          <c:if test="${evento.getStatusEvento() == 0}">
                            <a class="btn btn-warning" href="CambiarStatusEventoServlet?idEvento=${evento.getIdEvento()}&statusEvento=${evento.getStatusEvento()}"><i class="icon_close_alt2"></i></a>
                          </c:if>
                          ...
                          <c:if test="${evento.getStatusEvento() == 4}">
                            <a class="btn btn-info" href="CambiarStatusEventoServlet?idEvento=${evento.getIdEvento()}&statusEvento=${evento.getStatusEvento()}"><i class="icon_pencil-edit"></i></a>
                          </c:if>
                        </div>
                      </td>
                    </c:if>
                    <td>
                      <a class="btn btn-danger" href="EliminarEventoServlet?idEvento=${evento.getIdEvento()}&statusEvento=${evento.getStatusEvento()}">Eliminar</i></a>
                    </td>
                  </tr>
                </c:forEach>
                ...
                <c:forEach items="${listaNoticias}" var="noticia">
                  <tr>
                    ...
                    <td>
                      ...
                      <c:if test="${noticia.getStatusNoticia() == 4}">Sin Revisar</c:if>
                    </td>
                    <c:if test="${sessionUser.getRolUsuario() == 'admin'}">
                      <td>
                        <div class="btn-group">
                          <c:if test="${noticia.getStatusNoticia() == 0}">
                            <a class="btn btn-warning" href="CambiarStatusNoticiaServlet?idNoticia=${noticia.getIdNoticia()}&statusNoticia=${noticia.getStatusNoticia()}"><i class="icon_close_alt2"></i></a>
                          </c:if>
                          ...
                          <c:if test="${noticia.getStatusNoticia() == 4}">
                            <a class="btn btn-info" href="CambiarStatusNoticiaServlet?idNoticia=${noticia.getIdNoticia()}&statusNoticia=${noticia.getStatusNoticia()}"><i class="icon_pencil-edit"></i></a>
                          </c:if>
                        </div>
                      </td>
                    </c:if>
                    <td>
                      <a class="btn btn-danger" href="EliminarNoticiaServlet?idNoticia=${noticia.getIdNoticia()}&statusNoticia=${noticia.getStatusNoticia()}">Eliminar</i></a>
                    </td>
                  </tr>
                </c:forEach>
