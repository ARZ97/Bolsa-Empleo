                                            ...
                                            <div id="c-eventos" class="carousel slide auto panel-body">
                                                <ol class="carousel-indicators out">
                                                  <c:forEach items="${eventosDAO}" var="evento">
                                                    ...
                                                    <c:if test="${actives.getEventoActive() == 1}">
                                                      <li class="active" data-slide-to="${actives.getEventoActive()}" data-target="#c-eventos" class="active"></li>
                                                      ${actives.setEventoActive()}
                                                    </c:if>
                                                  ...
                                                  <c:forEach items="${eventosDAO}" var="evento">
                                                    <c:if test="${actives.getEventoActive2() > 1}">
                                                      <div class="item text-center">
                                                        <img width="100%" src="GetImagenEventoServlet?id=${evento.getIdEvento()}" alt="">
                                          ...
                                          <div id="c-noticias" class="carousel slide auto panel-body">
                                              <ol class="carousel-indicators out">
                                                <c:forEach items="${noticiasDAO}" var="noticia">
                                                  ...
                                                  <c:if test="${actives.getNoticiaActive() == 1}">
                                                    <li class="active" data-slide-to="${actives.getNoticiaActive()}" data-target="#c-noticias"  class="active"></li>
                                                    ${actives.setNoticiaActive()}
                                                  </c:if>
                                              ...
                                              <div class="carousel-inner">
                                                ...
                                                <c:forEach items="${noticiasDAO}" var="noticia">
                                                  <c:if test="${actives.getNoticiaActive2() > 1}">
                                                    <div class="item text-center">
                                                      <img width="100%" src="GetImagenNoticiaServlet?id=${noticia.getIdNoticia()}" alt="">
                                                      <div class="carousel-caption d-none d-md-block"></div>
                    ...
                    <div class="table-responsive" style="overflow-x:auto;" >
                      <table class="table table-striped table-advance table-hover" >
                        <thead>
                            ...
                            <th></i>Responder</th>
                            <c:if test="${sessionUser.getRolUsuario() == 'admin'}">
                              <th><i class="icon_check"></i>Estado</th>
                        ...
                        <tbody>
                          <c:forEach items="${vacantesDAO}" var="vacante">
                            <tr>
                              ...
                              <td><a href="GetPdfVacanteServlet?idVacante=${vacante.getIdVacante()}" target="_blank"><i class="icon_download"></i></a></td>
                              <td><a href="EnviarCVPageServlet?idVacante=${vacante.getIdVacante()}"><i class="icon_upload"></i></a></td>
                              <c:if test="${sessionUser.getRolUsuario() == 'admin'}">
                                <td>
                                ...
                                <td>
                                  <div class="btn-group">
                                    <c:if test="${vacante.getStatusVacante() == 0}">
                                      <a class="btn btn-warning" href="CambiarStatusVacanteServlet?idVacante=${vacante.getIdVacante()}&statusVacante=${vacante.getStatusVacante()}"><i class="icon_close_alt2"></i></a>
                                    </c:if>
