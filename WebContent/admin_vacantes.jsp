                    ...
                    <c:forEach items="${adminVacantes}" var="vacante">
                      <tr>
                        ...
                        <td>
                          ...
                          <c:if test="${vacante.getStatusVacante() == 4}">Sin Revisar</c:if>
                        </td>
                        <c:if test="${sessionUser.getRolUsuario() == 'admin'}">
                          <td>
                            <div class="btn-group">
                              ...
                              <c:if test="${vacante.getStatusVacante() == 4}">
                                <a class="btn btn-info" href="CambiarStatusVacanteServlet?idVacante=${vacante.getIdVacante()}&statusVacante=${vacante.getStatusVacante()}"><i class="icon_pencil-edit"></i></a>
                              </c:if>
                            </div>
                          </td>
                        </c:if>
                        <td>
                          <a class="btn btn-danger" href="EliminarVacanteServlet?idVacante=${vacante.getIdVacante()}&statusVacante=${vacante.getStatusVacante()}">Eliminar</i></a>
                        </td>
                      </tr>
                    </c:forEach>
