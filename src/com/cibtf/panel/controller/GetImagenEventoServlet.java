...
/**
 * Servlet implementation class ControlerIMGeventos
 */
@WebServlet(name = "GetImagenEventoServlet", urlPatterns = {"/GetImagenEventoServlet"},loadOnStartup = -1)
public class GetImagenEventoServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	       ...
	       try {
	           ...
	           ps = Conexion.getConnection().prepareStatement("select imagen_evento from eventos where id_evento = ?;");
	           ps.setInt(1, id);
	           rs = ps.executeQuery();
	           while (rs.next()) {
	               b = rs.getBytes(1);
