...
public class EliminarUsuarioServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String html = formatoCorreosDAO.getFormatoAlerta("Usuario Eliminado", "Has sido dado de baja de nuestra plataforma y ya no podrás acceder a la misma.<br><br>Si consideras que ha sido un error favor de ponerte en contácto con nosotros y atenderemos tu caso a la brevedad para que puedas seguir usando la plataforma.", 0);
