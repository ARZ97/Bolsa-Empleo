...
public class CambiarStatusServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usuario.getStatusUsuario() == 1) {
			...
			System.out.println("Habilitar usuario:"+request.getParameter("correoUsuario"));
			FormatoCorreosDAO formatoCorreosDAO = new FormatoCorreosDAO();
			String html = formatoCorreosDAO.getFormatoNotificacion("¡En Horabuena!", "Tu usuario ha sido habilitado y ya puedes hacer uso de la plataforma con tu correo y tu contraseña.", 1);
			correoDAO.enviarCorreoDAO("Usuario Habilitado - CIBTF", html, "bolsaempleo.ad@gmail.com");
		}else if(usuario.getStatusUsuario() == 4) {
			usuario.setStatusUsuario(0);
		}
